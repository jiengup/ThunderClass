 ...
 * Use the {@link t_ppt#newInstance} factory method to
 * create an instance of this fragment.
 */
public class t_ppt extends Fragment {
     ...
     * @return A new instance of fragment t_ppt.
     */
    // TODO: Rename and change types and number of parameters
    public static t_ppt newInstance(String param1, String param2) {
        t_ppt fragment = new t_ppt();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_t_ppt, container, false);
    }
    ...
    private final Runnable task = new Runnable() {
        ...
        public void run() {
            if(!pptPushed) {
                getClassPPT(class_id, new VolleyCallback() {
                    @Override
    ...
    private void getClassPPT(int class_id, final VolleyCallback callback) {
