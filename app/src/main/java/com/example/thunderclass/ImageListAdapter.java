...
public class ImageListAdapter extends ArrayAdapter<ImageListArray> {
    ...
    public View getView(int position,  View convertView,  ViewGroup parent) {
        ...
        ImageView imageView = (ImageView)view.findViewById(R.id.IamgeView_List);////图片组件
        TextView useName = (TextView)view.findViewById(R.id.UseName_List); //从裁剪好的布局里获取TextView布局Id
        TextView nickName = (TextView)view.findViewById(R.id.NickName_List); //从裁剪好的布局里获取TextView布局Id
        TextView className = (TextView)view.findViewById(R.id.Class_List); //从裁剪好的布局里获取TextView布局Id

        //imageView.setImageResource();//插入图片
        //

        useName.setText(imageListArray.getUseName());//将当前一组imageListArray类中的TextView内容导入到TextView布局中
        nickName.setText(imageListArray.getNickName());//将当前一组imageListArray类中的TextView内容导入到TextView布局中
        className.setText(imageListArray.getClassName());//将当前一组imageListArray类中的TextView内容导入到TextView布局中
        Glide.with(view).load(imageListArray.getUrl()).into(imageView);
        return view;
