...
public class TeacherHomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener{
    ...
    void initUI() {
        Toolbar toolbar = findViewById(R.id.tc1_home_toolbar);
        setSupportActionBar(toolbar);
        DrawerLayout drawerLayout = findViewById(R.id.tc1_drawer_layout);
        NavigationView navigationView = findViewById(R.id.tc1_nav);
        ...
        profile = header.findViewById(R.id.tc1_profile);
        profile.setOnClickListener(this);
        TextView tc1_name = profile.findViewById(R.id.tc1_profile_name);
        TextView tc1_school = profile.findViewById(R.id.tc1_profile_school);
        TextView tc1_type = profile.findViewById(R.id.tc1_profile_type);
        ImageView portrait = profile.findViewById(R.id.tc1_profile_portrait);
        tc1_name.setText(username);
        tc1_school.setText(userSchool);
        ...
        customBanner = findViewById(R.id.tc1_banner);
        ...
        setBean(images);
        RecyclerView recyclerView = findViewById(R.id.tc1_rcv);
        ...
        courseAdapter.setOnItemClickListener(new CourseAdapter.OnItemClickListener() {
            ...
            public void onClick(int position) {
                ...
                intent.setClass(TeacherHomeActivity.this, TeacherTwoActivity.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if(id == R.id.tc1_nav_create) {
            Intent intent = new Intent();
            intent.putExtra("username", username);
            intent.setClass(TeacherHomeActivity.this, CourseCreateActivity.class);
            startActivity(intent);
        } else if(id == R.id.tc1_nav_ppts) {
            Intent intent = new Intent();
            intent.putExtra("username", username);
            intent.setClass(TeacherHomeActivity.this, PptListActivity.class);
            startActivity(intent);
        } else if(id == R.id.tc1_nav_logout) {
            mEditor.clear();
            mEditor.commit();
            Intent intent = new Intent(TeacherHomeActivity.this, UserLoginActivity.class);
            startActivity(intent);
        } else if(id == R.id.tc1_nav_exercises) {
            Intent intent = new Intent();
            intent.putExtra("username", username);
            intent.setClass(TeacherHomeActivity.this, ExerciseListActivity.class);
            startActivity(intent);
        }
        return true;
    }
